...
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
    ...
    with ThreadPool(max_workers=40) as Hasan_Asha:
        ...
        for love in user:
            ...
            uid = code+love
            if 'M1' in nabil:
            	MR_SHIPU.submit(Asraful1,uid,pwx,tl)
            elif 'M2' in nabil:
            	MR_SHIPU.submit(Asraful2,uid,pwx,tl)
            elif 'M3' in nabil:
            	MR_SHIPU.submit(Asraful3,uid,pwx,tl)
            elif 'M4' in nabil:
            	MR_SHIPU.submit(Asraful4,uid,pwx,tl)
            elif 'M5' in nabil:
            	MR_SHIPU.submit(Asraful5,uid,pwx,tl)
            else:
            	MR_SHIPU.submit(Asraful1,uid,pwx,tl)
#•••••••••••••••••••••••••M-UPDATE M1••••••••••••••••••••••••••#
#••••••••••••••••••••SCRIPT MATHOID M1•••••••••••••••••••••#
